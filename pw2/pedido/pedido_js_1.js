...
//
    function ajxMostrarDadosPedido() {
        $.ajax({
            ...
            //dataType: 'html',
            type: 'POST',
            data: {acao: 'mostrarDadosTelaPedido'},
            beforeSend: function () {
                $("#enredeco").html('<label class="alert alert-info col-md-12">Carregando Endereço...<img src="images/ring.svg" style="width:50px;height:50px;"/></label>');
            },
            success: function (dados) {
                $("#endereco").html("Mostrar Endereco");
                
                console.info('retorno mostrarDadosPedido: ', dados);
            }
        });
    }
//
