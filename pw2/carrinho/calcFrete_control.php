<?php
    ...
    if ($acao == "calcFrete") {  // mostra a listagem
        ...
        for($cont = 0; $cont < 3; $cont++) {
            ...
            if($erro == 0) {
                $htm .= '';
                    $htm .= '<input type="radio" id="entrega" name="entrega" value="'
                            .$modalidades[$cont].'" /> '
                            .$servico.': R$ <span class="val_frete'
                            .$modalidades[$cont].'">'
                            .$cf->Valor.'</span> - Prazo Estimado: <span class="prazo_frete">'
                            .$cf->PrazoEntrega.'</span> dia(s)';
